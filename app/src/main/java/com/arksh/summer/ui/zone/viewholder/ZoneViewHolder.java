...
import com.arksh.common.activity.BigImagePagerActivity;
...
import com.arksh.summer.ui.zone.adapter.CircleAdapter;
import com.arksh.summer.ui.zone.adapter.CommentAdapter;
import com.arksh.summer.ui.zone.adapter.FavortListAdapter;
...
import com.arksh.summer.ui.zone.spannable.ISpanClick;
import com.arksh.summer.ui.zone.widget.CommentDialog;
import com.arksh.summer.ui.zone.widget.CommentListView;
import com.arksh.summer.ui.zone.widget.ExpandableTextView;
import com.arksh.summer.ui.zone.widget.FavortListView;
import com.arksh.summer.ui.zone.widget.MultiImageView;
...
public class ZoneViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setData(CircleZonePresenter mPresenter2, CircleItem circleItem2, final int position2){
            ...
            default:
                ...
                if (photos != null && photos.size() > 0) {
                    ...
                    multiImageView.setOnItemClickListener((view, position1) -> {
                        // 查看大图
                        BigImagePagerActivity.startImagePagerActivity((Activity) mContext, photos, position1);
                    });
                } else {
        ...
        if (hasFavort || hasComment) {
            ...
            if (hasComment) {
                //点击评论
                commentList.setOnItemClick(commentPosition -> {
                ...
                //长按评论
                commentList.setOnItemLongClick(commentPosition -> {
                    //长按进行复制或者删除
                    CommentItem commentItem = commentsDatas.get(commentPosition);
                    CommentDialog dialog = new CommentDialog(mContext, mPresenter, commentItem, position,commentPosition);
                    dialog.show();
        ...
        //评论
        snsBtn.setOnClickListener(view -> comment(circleItem.getId(), circleItem.getUserId(), position));
        ll_comment.setOnClickListener(view -> comment(circleItem.getId(), circleItem.getUserId(), position));
        //点赞
        favortBtn.setOnClickListener(view -> {
            //判断是否已点赞
