...
import com.arksh.summer.ui.news.activity.PhotosDetailActivity;
import com.arksh.summer.ui.news.contract.PhotoListContract;
import com.arksh.summer.ui.news.model.PhotosListModel;
import com.arksh.summer.ui.news.presenter.PhotosListPresenter;
...
public class PhotoMainFragment extends BaseFragment<PhotosListPresenter, PhotosListModel> implements PhotoListContract.View,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void initView() {
        ...
        adapter = new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper, final PhotoGirl photoGirl) {
                ...
                imageView.setOnClickListener(view -> PhotosDetailActivity.startAction(mContext,photoGirl.getUrl()));
            }
        };
        ...
        fab.setOnClickListener(view -> irc.smoothScrollToPosition(0));
